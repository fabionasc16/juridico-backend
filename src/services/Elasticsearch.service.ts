...
export class LogsService {
  ...
  public static MODULE = {'PROCESSO':'PROCESSO',  'RESPONSAVEIS':'RESPONSÁVEIS','FERIADOS':'FERIADOS','ORGAOS':'ORGÃOS','TIPOS_PROCESSO':'TIPOS PROCESSO', 'USUARIOS':'USUÁRIOS','ASSUNTOS':'ASSUNTOS','CLASSIFICACAO':'CLASSIFICAÇÃO'};
