...
export class LogsService {
  ...
  public static TRANSACTION = { 'CADASTRAR': 'CADASTRAR', 'EDITAR': 'EDITAR', 'EDITAR_STATUS': 'ALTERAR SITUAÇÃO DO PROCESSO', 'LISTAR': 'LISTAR', 'EXCLUIR': 'EXCLUIR', 'TRAMITAR': 'TRAMITAR', 'VISUALIZAR': 'VISUALIZAR', 'BUSCAR_PROCESSO': 'BUSCAR PROCESSO', 'BUSCAR_PROCESSO_DESCRICAO': 'BUSCAR PROCESSO DESCRICAO', 'MOVIMENTACOES_PROCESSO': 'MOVIMENTACOES PROCESSO', 'CAIXAS_SIGED': 'CAIXAS SIGED' };
